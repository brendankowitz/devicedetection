...
namespace ZeroProximity.DeviceDetection.Defaults
{
    public static class MobileDetectionUserAgents
    {
        ...
        public static readonly IDictionary<string, DeviceType> MobileComparisonList = new Dictionary<string, DeviceType>
                    {
        ...
        public static readonly IDictionary<string, DeviceType> TabletOverrideComparisonList = new Dictionary<string, DeviceType>
                    {
                        //galaxy tab 7
